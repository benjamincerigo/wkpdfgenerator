...
test_objs = bin/obj/Url.o bin/obj/error.o $(OBJ)/testqueryget.o
fulltest_objs = bin/obj/full_test.o bin/obj/ClientSocket.o bin/obj/Socket.o bin/obj/error.o $(OBJ)/SocketException.o
...
build: $(OBJECT_FILES) wkpdfgenerator client timeouttest fulltest 
...
testqueryget: $(test_objs)
	$(CC) $(LDFLAGS) -o $(BIN)/$@ $(test_objs)

fulltest: $(fulltest_objs)
	$(CC) $(LDFLAGS) -o $(BIN)/$@ $(fulltest_objs)
